...
const (
	...
	// JSStreamExpectedLastSubjectVersionInvalidErr invalid expected last subject version
	JSStreamExpectedLastSubjectVersionInvalidErr ErrorIdentifier = 10224

	// JSStreamExpectedLastSubjectVersionRequiresVersioningErr expected last subject version requires subject versioning
	JSStreamExpectedLastSubjectVersionRequiresVersioningErr ErrorIdentifier = 10225
	...
	// JSStreamSubjectVersionHeaderServerManagedErrF {header} is server managed on subject versioned streams
	JSStreamSubjectVersionHeaderServerManagedErrF ErrorIdentifier = 10226
	...
	// JSStreamWrongLastSubjectVersionConstantErr wrong last subject version
	JSStreamWrongLastSubjectVersionConstantErr ErrorIdentifier = 10227

	// JSStreamWrongLastSubjectVersionErrF wrong last subject version: {version}
	JSStreamWrongLastSubjectVersionErrF ErrorIdentifier = 10228
...
var (
	ApiErrors = map[ErrorIdentifier]*ApiError{
		...
		JSStreamExpectedLastSubjectVersionInvalidErr:            {Code: 400, ErrCode: 10224, Description: "invalid expected last subject version"},
		JSStreamExpectedLastSubjectVersionRequiresVersioningErr: {Code: 400, ErrCode: 10225, Description: "expected last subject version requires subject versioning"},
		...
		JSStreamSubjectVersionHeaderServerManagedErrF:           {Code: 400, ErrCode: 10226, Description: "{header} is server managed on subject versioned streams"},
		...
		JSStreamWrongLastSubjectVersionConstantErr:              {Code: 400, ErrCode: 10227, Description: "wrong last subject version"},
		JSStreamWrongLastSubjectVersionErrF:                     {Code: 400, ErrCode: 10228, Description: "wrong last subject version: {version}"},
...
// NewJSStreamExpectedLastSubjectVersionInvalidError creates a new JSStreamExpectedLastSubjectVersionInvalidErr error: "invalid expected last subject version"
func NewJSStreamExpectedLastSubjectVersionInvalidError(opts ...ErrorOption) *ApiError {
	eopts := parseOpts(opts)
	if ae, ok := eopts.err.(*ApiError); ok {
		return ae
	}

	return ApiErrors[JSStreamExpectedLastSubjectVersionInvalidErr]
}

// NewJSStreamExpectedLastSubjectVersionRequiresVersioningError creates a new JSStreamExpectedLastSubjectVersionRequiresVersioningErr error: "expected last subject version requires subject versioning"
func NewJSStreamExpectedLastSubjectVersionRequiresVersioningError(opts ...ErrorOption) *ApiError {
	eopts := parseOpts(opts)
	if ae, ok := eopts.err.(*ApiError); ok {
		return ae
	}

	return ApiErrors[JSStreamExpectedLastSubjectVersionRequiresVersioningErr]
}
...
// NewJSStreamSubjectVersionHeaderServerManagedError creates a new JSStreamSubjectVersionHeaderServerManagedErrF error: "{header} is server managed on subject versioned streams"
func NewJSStreamSubjectVersionHeaderServerManagedError(header interface{}, opts ...ErrorOption) *ApiError {
	eopts := parseOpts(opts)
	if ae, ok := eopts.err.(*ApiError); ok {
		return ae
	}

	e := ApiErrors[JSStreamSubjectVersionHeaderServerManagedErrF]
	args := e.toReplacerArgs([]interface{}{"{header}", header})
	return &ApiError{
		Code:        e.Code,
		ErrCode:     e.ErrCode,
...
// NewJSStreamWrongLastSubjectVersionConstantError creates a new JSStreamWrongLastSubjectVersionConstantErr error: "wrong last subject version"
func NewJSStreamWrongLastSubjectVersionConstantError(opts ...ErrorOption) *ApiError {
	eopts := parseOpts(opts)
	if ae, ok := eopts.err.(*ApiError); ok {
		return ae
	}

	return ApiErrors[JSStreamWrongLastSubjectVersionConstantErr]
}

// NewJSStreamWrongLastSubjectVersionError creates a new JSStreamWrongLastSubjectVersionErrF error: "wrong last subject version: {version}"
func NewJSStreamWrongLastSubjectVersionError(version interface{}, opts ...ErrorOption) *ApiError {
	eopts := parseOpts(opts)
	if ae, ok := eopts.err.(*ApiError); ok {
		return ae
	}

	e := ApiErrors[JSStreamWrongLastSubjectVersionErrF]
	args := e.toReplacerArgs([]interface{}{"{version}", version})
	return &ApiError{
		Code:        e.Code,
		ErrCode:     e.ErrCode,
		Description: strings.NewReplacer(args...).Replace(e.Description),
